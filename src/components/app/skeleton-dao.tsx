...
export function ProposalsTabSkeleton() {
  return (
    <div className="w-full bg-transparent space-y-4">
      {/* Stats Cards - Commented out since using mock data for "All-time voter's turnout" and "Top 3 most active members" */}
      {/* 
      ...
      <div className="bg-[#FFFFFF] dark:bg-[#010101] dark:border dark:border-[#282828B2] rounded-[5px] flex flex-col gap-2">
        ...
        <div className="p-4 space-y-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="border-b border-[#E7E7E7] dark:border-[#282828B2] pb-3"
            >
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="p-4 border border-[#E7E7E7] dark:border-[#282828B2] rounded"
            >
