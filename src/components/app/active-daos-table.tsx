  ...
  return (
    <div className="bg-white dark:bg-[#171717] space-y-8 min-h-[810px] flex flex-col items-center justify-center w-full">
      <Image
        ...
        height={316}
      />
      <div className="text-center">There’s no DAO that have active proposal currently.</div>
    </div>
  );
};

export default function ActiveDaosTable({
  data,
  onLoadMore,
  isLoadingMore,
}: {
  ...
  return (
    <>
      <div className="hidden md:block lg:max-w-[1200px] bg-white dark:bg-[#010101] mx-auto rounded-[10px] border-b-[0.5px] dark:border-[0.5px] dark:border-[#282828B2] overflow-hidden">
